...
public class AuthorsLocators {
    ...
    public static final SelenideElement TXT_ORGANIZATION_NAME = $("//textarea[@id='orgname' and @name='orgname']");
    ...
    public static final SelenideElement SELECT_SORTORDER = $("//select[@id='sortorder' and @name='sortorder']");
