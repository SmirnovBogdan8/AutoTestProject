...
public class NeuralSearchLocators {
    ...
    public static final SelenideElement LINK_SELECT_ALL_PUBLICATIONS = $("//a[text()='Выделить все публикации на этой странице']");
    public static final SelenideElement LINK_CLEAR_SELECTION = $("//a[text()='Снять выделение']");
    public static final SelenideElement LINK_ADD_SELECTED_TO_COLLECTION = $("//a[text()='Добавить выделенные публикации в подборку']");
    public static final SelenideElement LINK_ADD_ALL_TO_COLLECTION = $("//a[text()='Добавить все результаты поиска в подборку']");
