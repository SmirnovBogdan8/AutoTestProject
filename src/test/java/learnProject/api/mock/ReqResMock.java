...
public class ReqResMock {
    ...
    public static void run() throws FileNotFoundException {
        ...
        stubFor(get(urlPathEqualTo("/learnProject/api/users"))
        ...
        stubFor(get(urlPathEqualTo("/learnProject/api/users/2"))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(get(urlPathEqualTo("/learnProject/api/users/23"))
                .willReturn(aResponse()
                        .withStatus(404)
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(get(urlPathEqualTo("/learnProject/api/unknown"))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(get(urlPathEqualTo("/learnProject/api/unknown/2"))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(get(urlPathEqualTo("/learnProject/api/unknown/23"))
                .willReturn(aResponse()
                        .withStatus(404)
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(post(urlEqualTo("/learnProject/api/users"))
                .willReturn(aResponse()
                        .withStatus(201)
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(put(urlEqualTo("/learnProject/api/users/2"))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(patch(urlEqualTo("/learnProject/api/users/2"))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(delete(urlEqualTo("/learnProject/api/users/2"))
                .willReturn(aResponse()
                        .withStatus(204)
                        .withHeader("Content-Type", "application/json")
        ...
        stubFor(post(urlEqualTo("/learnProject/api/register"))
        ...
        stubFor(post(urlEqualTo("/learnProject/api/login"))
                .withRequestBody(containing("\"email\": \"eve.holt@reqres.in\""))
                .willReturn(aResponse()
                        .withStatus(200)
                        .withHeader("Content-Type", "application/json")
